  ...
  return (
    <PrintableLayout>
      ...
      >
        ...
        <section className="w-[210mm] h-[297mm] mx-auto p-8 flex flex-col bg-white print:shadow-none shadow-lg mb-8 print:mb-0 overflow-hidden">
          <PrintableHeader />
          <SkillsSection />
        ...
        <section className="w-[210mm] h-[297mm] mx-auto p-8 flex flex-col bg-white print:shadow-none shadow-lg mb-8 print:mb-0 page-break-before overflow-hidden">
          <ExperienceSection />
          <PrintableFooter pageNumber={2} />
        </section>

        {/* Página 3: Educação e Competências */}
        <section className="w-[210mm] h-[297mm] mx-auto p-8 flex flex-col bg-white print:shadow-none shadow-lg page-break-before overflow-hidden">
          <EducationSection />
